...
COPY = {
    "cz": {
        ...
        "ty_alt": "Tým nexofind v práci: call centrum a logistika dobírky",
    },
}
...
def si_copy():
    return {
        ...
        "ty_alt": "Ekipa nexofind pri delu: klicni center in logistika COD",
    }
...
def hu_copy():
    return {
        ...
        "ty_alt": "A nexofind csapat munka közben: call center és COD logisztika",
    }
...
def sk_copy():
    ...
    c.update({
        ...
        "ty_alt": "Tím nexofind v práci: call centrum a logistika dobierky",
    })
    return c
...
def pl_copy():
    return {
        ...
        "ty_alt": "Zespół nexofind w pracy: call center i logistyka COD",
    }
...
def transform_lp(geo: str, g: dict, c: dict) -> str:
    ...
    t = t.replace("https://nexofind.com/it/fold360/", f"https://nexofind.com/{geo}/fold360/")
...
def transform_ty(geo: str, g: dict, c: dict) -> str:
    ...
    t = t.replace("Il team nexofind al lavoro: call center e logistica COD", c["ty_alt"])
...
def main():
    ...
    for geo in GEOS:
        url = f"https://nexofind.com/{geo}/fold360/"
        if url not in text:
            entry = f'  <url><loc>{url}</loc><lastmod>2026-07-25</lastmod><changefreq>weekly</changefreq><priority>0.95</priority></url>\n'
            text = text.replace(
                "  <url><loc>https://nexofind.com/it/fold360/</loc>",
                entry + "  <url><loc>https://nexofind.com/it/fold360/</loc>",
                1,
            )
